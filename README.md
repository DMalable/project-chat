...
## Как запускать проект c сервером

1. Запустите сервер `node projects/[имя проекта]/server/index.js`, например, `node projects/my-chat/server/index.js`
2. Запустите `npm start`
3. Откройте `http://localhost:8080/[имя проекта]`, например, `http://localhost:8080/my-chat`
